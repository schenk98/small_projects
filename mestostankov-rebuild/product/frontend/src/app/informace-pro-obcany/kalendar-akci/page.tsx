...
import { extractKalendarItems } from "@/lib/listExtractors";

const BASE = "/informace-pro-obcany/kalendar-akci/";
const SOURCE_URL = "https://www.mestostankov.cz/informace-pro-obcany/kalendar-akci/";

export default async function KalendarListPage({
  searchParams,
}: {
  ...
  const items = raw ? extractKalendarItems(raw) : [];
  ...
  return (
    <div className="min-h-full">
      ...
      <main className="container" style={{ paddingTop: "2rem", paddingBottom: "2rem" }}>
        <h1 style={{ fontSize: "1.75rem", fontWeight: 900, margin: 0 }}>Kalendář akcí</h1>
        <p style={{ color: "var(--muted)", marginTop: "0.5rem" }}>
          Přehled akcí (kino, kultura, sport…).
        </p>
