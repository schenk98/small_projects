/**
 * Dashboard reward-preview blob: camelCase from Spring, with fallbacks for snake_case
 * and optional minigame keys. Used by the minigames hub and energy-cost hints.
 */
